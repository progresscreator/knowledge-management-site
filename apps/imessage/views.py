...
from imessage.forms import ComposeForm
from imessage.utils import format_quote
...
def inbox(request, template_name='imessage/inbox.html'):
    """
...
def outbox(request, template_name='imessage/outbox.html'):
    """
...
def trash(request, template_name='imessage/trash.html'):
    """
...
def compose(request, recipient=None, form_class=ComposeForm,
        template_name='imessage/compose.html', success_url=None, recipient_filter=None):
    """
...
def view(request, message_id, template_name='imessage/view.html'):
    """
